...
import com.Teachers.HaziraKhataByGk.constant.ContactField;
...
public class SQLiteDB extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "class_item.db";
    ...
    public void create(class_item classitem){
        // Gets the data repository in write mode
        SQLiteDatabase db = getWritableDatabase();

        // Create a new map of values, where column names are the keys
        ContentValues values = new ContentValues();
        values.put(ContactField.COLUMN_NAME, classitem.getName());
        values.put(ContactField.COLUMN_PHONE, classitem.getSection());
    ...
    public void update(class_item classitem){
        SQLiteDatabase db = getReadableDatabase();
        ...
        String[] selectionArgs = { String.valueOf(classitem.getName()) };
