...
public class newsAdapter extends RecyclerView.Adapter<newsViewHolder> {
    ...
    public newsAdapter(ArrayList<news_item> Data) {
        list = Data;
    }
...
//TODO:set saved icon on onBindViewHolder not onCreateViewHolder
    ...
    public void onBindViewHolder(final newsViewHolder holder, int position) {
        ...
        if(MainActivity.isNewsBookmarked(list.get(position))){
            savedIcon.setImageResource(R.drawable.ic_saved_icon);
        }
        if(MainActivity.isNewsLoved(MainActivity.context,list.get(position).getURL(),list.get(position).getHeading(),list.get(position).getDate())){
