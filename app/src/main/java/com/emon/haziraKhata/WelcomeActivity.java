...
import com.emon.haziraKhata.Widget.PrefManager;
...
public class WelcomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.intro1_class_room,
                R.layout.intro2_nibondhon,
                R.layout.intro3_news,
                R.layout.intro4_job,
                R.layout.intro5_tottho_jhuri,
                R.layout.intro6_shikkhok_kothon,
                R.layout.intro7_reminder,
                R.layout.intro8_textbook
        };
